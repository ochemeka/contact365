...
const features = [
  ...
  },
  {
    ...
    text: "From plumbers to hospitals, discover trusted businesses in your neighborhood.",
  ...
  },
  {
    ...
    text: "Connect with authentic Nigerian businesses from small vendors to corporate enterprises.",
...
export default function ExplorePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Features Section */}
{/* Features Section */}
<section className="w-full py-20 mt-10 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 shadow-sm">
  <div className="text-center mb-12 px-4">
    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white leading-snug">
      ...
      <span className="text-green-600 dark:text-green-400">
        Find trusted local businesses around you
      </span>
    </h2>
  </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Find the best Nigerian businesses across all categories, from essential services to specialized professionals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
            {[
              ...
              { name: "Education", icon: "📚", gradient: "from-purple-500 to-pink-500" },
              { name: "Real Estate", icon: "🏘️", gradient: "from-green-500 to-emerald-500" },
              { name: "Automotive", icon: "🚗", gradient: "from-gray-600 to-gray-700" },
              { name: "Plumbing", icon: "🔧", gradient: "from-blue-600 to-indigo-600" },
              { name: "Electrical", icon: "⚡", gradient: "from-yellow-500 to-orange-500" },
              { name: "Beauty & Spa", icon: "💇", gradient: "from-pink-500 to-rose-500" },
              { name: "Fitness", icon: "💪", gradient: "from-red-500 to-orange-500" },
              { name: "Legal Services", icon: "⚖️", gradient: "from-gray-700 to-gray-800" },
              { name: "Accounting", icon: "💼", gradient: "from-blue-700 to-blue-800" },
              { name: "Construction", icon: "🏗️", gradient: "from-amber-600 to-orange-600" },
              { name: "Cleaning", icon: "🧹", gradient: "from-teal-500 to-cyan-500" },
              { name: "Security", icon: "🛡️", gradient: "from-red-600 to-red-700" },
              { name: "Photography", icon: "📸", gradient: "from-purple-600 to-indigo-600" },
              { name: "Event Planning", icon: "🎉", gradient: "from-pink-600 to-purple-600" },
              { name: "Catering", icon: "🍰", gradient: "from-orange-500 to-red-400" },
              { name: "Fashion", icon: "👗", gradient: "from-fuchsia-500 to-pink-500" },
              { name: "Technology", icon: "💻", gradient: "from-blue-500 to-purple-500" },
              { name: "Agriculture", icon: "🌾", gradient: "from-green-600 to-lime-600" },
              { name: "Logistics", icon: "🚚", gradient: "from-indigo-600 to-blue-600" },
              { name: "Hospitality", icon: "🏨", gradient: "from-amber-500 to-orange-500" },
              { name: "Pet Services", icon: "🐾", gradient: "from-brown-500 to-amber-600" },
              { name: "Home Services", icon: "🏠", gradient: "from-cyan-600 to-blue-600" },
            ].map((category, index) => (
              <motion.button
                key={category.name}
                ...
                whileTap={{ scale: 0.95 }}
                className={`group relative p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 ${
              ...
              >
                <div className="flex flex-col items-center space-y-3">
                  <div className={`text-4xl transform group-hover:scale-110 transition-transform duration-300 ${
                    activeCategory === category.name ? "drop-shadow-lg" : ""
                  }`}>
                    {category.icon}
                  </div>
          ...
          <div className="text-center mt-10">
            <button
              ...
              className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              View All Categories
            </button>
          </div>
              ...
              {(showFilters || isDesktop) && (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Search for plumbers, hospitals, restaurants..."
                      value={searchQuery}
                        ...
                        <div className="min-w-[200px] max-w-[200px] bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md overflow-hidden transition">
                          ...
                          <div className="p-3">
                            ...
                            <div className="flex items-center justify-between mt-2">
                              ...
                              {item.price && (
                                <p className="text-green-600 dark:text-green-400 font-bold text-xs">
                                  {item.price}
                                </p>
                              )}
                            </div>
                          ...
                          <div className="p-4 flex-1">
                            <div className="flex items-start justify-between mb-2">
                              ...
                              {(item.featured || item.trending) && (
                                <div className="flex gap-1 ml-2">
                                  {item.featured && (
                                    <span className="bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300 text-xs px-2 py-1 rounded-full whitespace-nowrap">
                                      Featured
                                    </span>
                                  )}
                                  {item.trending && (
                                    <span className="bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-300 text-xs px-2 py-1 rounded-full whitespace-nowrap">
                                      Trending
                                    </span>
                                  )}
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                <MapPin size={14} /> 
                                <span className="line-clamp-1">{item.area}, {item.lga}</span>
                              </div>
              ...
              <div className="space-y-3">
                {nigeriaLocationData.slice(0, 5).map((state) => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-sm font-medium text-gray-900 dark:text-white">{state.state}</span>
                ...
                <button
                  ...
                  className="w-full mt-3 text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-medium text-left"
                >
                  View all states →
                </button>
              </div>
        ...
        >
          <motion.div {...fadeInUp} className="relative z-10 container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              List Your Nigerian Business
            </h2>
            <p className="mb-8 opacity-90 text-lg max-w-2xl mx-auto">
              Join thousands of Nigerian businesses and reach customers across the nation. From local services to corporate enterprises.
            </p>
