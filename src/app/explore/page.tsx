        ...
        <div className="relative w-full h-[70vh] mb-12 overflow-hidden rounded-2xl shadow-lg flex items-center justify-center">
          ...
          <div className="relative z-10 text-center w-full max-w-4xl px-6">
            ...
            <p className="text-lg sm:text-xl text-gray-200 mb-6">
              From plumbers to hospitals, find trusted local services across Nigeria.
            </p>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-10">
            ...
            {featuredItems.length > 0 && (
              <div className="mt-10">
                <h2 className="text-xl font-bold flex items-center gap-2 mb-4 text-green-700 dark:text-green-400">
...
//   // Add theme state to sync with Header
//   const [theme, setTheme] = useState<"light" | "dark">("light");

//   // Theme effect - sync with localStorage and system preference
//   useEffect(() => {
...
//     // Listen for localStorage changes (from Header component)
...
//                       className="flex-1 outline-none text-sm bg-transparent disabled:opacity-50 text-gray-900 dark:text-gray-100"
//                     >
//                       <option value="All">
...
//                   value={searchQuery}
//                   onChange={(e) => setSearchQuery(e.target.value)}
//                   className="flex-1 outline-none text-sm bg-transparent text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
//                 />
//                 <button
//                   type="submit"
...
//                         onChange={(e) => setSelectedState(e.target.value)}
//                         disabled={selectedCountry === "All"}
//                         className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 disabled:opacity-50 text-gray-900 dark:text-gray-100"
//                       >
//                         <option value="All">
//                           {selectedCountry === "All" ? "Select Country First" : "All States"}
//                         </option>
...
//             {featuredItems.length > 0 && (
//               <div className="mt-10">
//                 <h2 className="text-xl font-bold flex items-center gap-2 mb-4 text-purple-700 dark:text-purple-400">
//                   <Sparkles size={20} /> Featured Businesses
//                   {selectedCountry !== "All" && (
//                     <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
//                       in {selectedCountry}
...
//                   className="w-full mt-3 text-sm text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium"
//                 >
//                   View all countries →
//                 </button>
//               </div>
