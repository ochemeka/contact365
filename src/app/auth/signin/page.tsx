...
export default function SignInPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Simple dummy validation - any email and password will work
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-10 py-2 text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  />
                  <button
                    type="button"
